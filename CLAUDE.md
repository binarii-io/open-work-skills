...
# CLAUDE.md - open-work-skills Project Instructions

You are assisting with the **open-work-skills** project — a system for discovering, documenting, and sharing organizational context and repository setup knowledge, compatible with Claude Code and other Claude-based tools.
...
├── .context/
│   └── context/
│       └── context.md             # Repository context (referenced below)
├── .github/
│   ├── copilot-instructions.md    # VS Code agent instructions
│   ├── prompts/
│   │   ├── repo-init.prompt.md
│   │   └── context-init.prompt.md
│   └── instructions/
├── CLAUDE.md                       # This file
├── onboarding/
│   └── vscode.md
